...
export default function StudentLayout({
  ...
  const displayInitials = avatarInitials || initialsFromName(user?.name);
      ...
      >
        <div>
          <div className="flex items-center justify-between px-4 py-4">
            <Logo label="Student" subtitle="Learner Access" />
            <Button
              variant="ghost"
              size="icon"
              className="h-8 w-8"
        ...
        <div className="space-y-1 border-t border-gray-100 p-3 dark:border-zinc-800">
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:text-zinc-400 dark:hover:bg-zinc-800"
          >
